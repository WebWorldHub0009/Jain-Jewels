...
const stats = [
  { label: "Years of Legacy", value: "25+", icon: <FaRegGem className="text-2xl sm:text-3xl md:text-4xl text-gray-600" /> },
  { label: "Happy Customers", value: "50K+", icon: <FaSmileBeam className="text-2xl sm:text-3xl md:text-4xl text-gray-600" /> },
  { label: "Jewellery Sold", value: "200K+", icon: <FaRing className="text-2xl sm:text-3xl md:text-4xl text-gray-600" /> },
  { label: "Artisan Experts", value: "100+", icon: <FaUsers className="text-2xl sm:text-3xl md:text-4xl text-gray-600" /> },
];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-20">
          {/* LEFT: Mobile Layout (Stacked) */}
          <div className="block md:hidden space-y-6">
            <div className="w-full rounded-xl overflow-hidden shadow-xl">
              <img src={statsImage1} alt="Jewelry 1" className="w-full h-60 object-cover" />
            </div>
            ...
            <div className="w-full rounded-xl overflow-hidden shadow-xl">
              <img src={statsImage2} alt="Jewelry 2" className="w-full h-60 object-cover" />
            </div>
          </div>

          {/* LEFT: Desktop & Tablet Layout (Overlapping) */}
          <motion.div
