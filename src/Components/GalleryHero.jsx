...
import heroImage from "../assets/images/owner/gallery-hero.avif"; // replace with your actual gallery banner image
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Explore our exquisite collection — where each design reflects elegance,
