...
import heroImage from "../assets/images/owner/antique-hero.jpg"; // Replace with your actual antique hero image
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Embrace heritage with handcrafted antique jewellery echoing royal charm and legacy.
        </motion.p>
...
export default HeroAntiqueCollection;
