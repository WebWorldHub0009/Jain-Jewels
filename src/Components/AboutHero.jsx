...
import heroImage from "../assets/images/advertise-1.jpg";
...
>
      ...
      >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl leading-relaxed text-gray-300 signature-font mb-6"
        >
        ...
        <p className="text-sm text-gray-400 mb-10 tracking-wider">
          Since decades, we’ve been creating memories, not just jewellery.
        </p>
        ...
        >
          <Link
            to="/gallery"
            className="inline-block px-8 py-3 bg-black text-white font-semibold border border-[#D4AF37] hover:bg-[#D4AF37] hover:text-black transition-all duration-300 rounded-full tracking-wider shadow-lg"
          >
            View Our Gallery
          </Link>
        </motion.div>
