...
import heroImage from "../assets/images/owner/jadaau-hero.jpg"; // 🔁 Replace with your actual Jadau jewellery hero image
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          An age-old tradition of royalty, revived with precision and passion.
        </motion.p>
...
export default HeroJadauJewellery;
